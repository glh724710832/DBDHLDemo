...
import com.gary.dbdhldemo.Adapter.JsonFourFragmentAdapter;
...
public class FourTabFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_four_tab,container,false);
    ...
    class MyHandler extends Handler{
        ...
        public void handleMessage(Message msg) {
            ...
            recyclerView.setAdapter(new JsonFourFragmentAdapter(getActivity(),trailers));
